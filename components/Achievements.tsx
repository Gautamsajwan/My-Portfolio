...
export default function Achievements({ }: Props) {
  ...
  return (
    <motion.div
      ...
      <div className="py-5 phone:py-3 w-full h-[80%] phone:h-[75%] flex gap-5 items-center overflow-hidden overflow-x-scroll scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-[#262626] snap-x snap-mandatory">
        {/* experience cards */}
        {
