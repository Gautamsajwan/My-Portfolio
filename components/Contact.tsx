...
export default function Contact({ }: Props) {
    ...
    return (
        <div className="mx-auto p-3 max-w-7xl h-screen relative font-montserrat flex flex-col justify-center gap-5">
            ...
            <form onSubmit={handleSubmit((data) => {
            ...
            })} className="flex flex-col phone:w-full justify-center mx-auto gap-3">
                <div className="flex phone:flex-col gap-3">
                    <div>
                ...
                <button type="submit" className="-mt-3 py-2 px-10 rounded-md font-bold bg-blue-400 text-xl transition-all duration-200 hover:bg-blue-500 active:scale-95">Submit</button>
            </form>
        </div>
    )
}