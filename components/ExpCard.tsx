...
export default function ExpCard({ logo, eventName, org, duration, work }: Props) {
  return (
    <article className="phone:w-[300px] w-[350px] lg:w-[420px] xl:w-[480px] h-full px-5 py-4 snap-center cursor-pointer flex flex-col items-center flex-shrink-0 rounded-2xl bg-[#2a2c2b] overflow-hidden z-20">
      <img className="h-24 w-24 object-cover rounded-full bg-gray-500" src={logo} alt="brand logo" />

      <div className="h-[78%] mt-1 py-2 outline lg:px-3 flex flex-col items-center">
